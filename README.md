...
A web-based multi-section attendance automation system built with Core PHP and MySQL, featuring separate interfaces for Admins and Faculties (Faculties).

## Features

### Admin Panel
- Register Faculties (individually or in bulk via CSV/Excel)
- Manage Faculty accounts (view, edit, delete)
...
1. **Admin Access**: Use the admin panel to register Faculties
2. **Faculty Access**: Faculties can log in and manage their sections
