<?php
// Faculty Navbar - include this at the top of Faculty panel pages
?>
<style>
/* Fixed navbar styles */
.faculty-navbar {
...
.faculty-navbar .nav-link.active, .faculty-navbar .nav-link:hover {
    color: #ffd700 !important;
}
.faculty-navbar .navbar-toggler {
    border: none;
    color: #fff;
    font-size: 1.5rem;
}
.faculty-navbar .navbar-toggler:focus {
    outline: none;
    box-shadow: none;
}
/* Mobile menu overlay */
...
.faculty-mobile-menu .close-menu {
    font-size: 2rem;
    color: #fff;
    position: absolute;
    top: 18px;
...
.faculty-mobile-menu .close-menu:hover {
    color: #ffd700;
}
.faculty-mobile-menu .nav-link {
    font-size: 1.2rem;
    margin: 12px 0;
    color: #fff !important;
}
@media (max-width: 991.98px) {
    .faculty-navbar .navbar-collapse {
...
<nav class="navbar faculty-navbar navbar-expand-lg navbar-dark">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="omProfileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-user"></i> <?php echo htmlspecialchars($_SESSION['faculty_name'] ?? 'Faculty'); ?>
                    </a>
...
<!-- Mobile menu overlay -->
<div class="faculty-mobile-menu" id="omMobileMenu">
