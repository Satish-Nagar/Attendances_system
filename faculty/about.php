                ...
                <div class="main-content">
                    ...
                    <div class="about-card">
                        <div class="text-center mb-4">
                            ...
                            <p class="lead">Complete User Manual & Feature Guide for Faculties</p>
                        </div>
                        
                        <div class="row">
                            <div class="col-md-6">
                                <h4><i class="fas fa-info-circle text-primary"></i> About the System</h4>
                                <p>QuickMark is a comprehensive attendance and assignment tracking system designed for educational institutions. As an Faculty (Faculty), you have access to powerful tools for managing student attendance, assignments, and academic records.</p>
                            </div>
                            <div class="col-md-6">
                                <h4><i class="fas fa-user-tie text-success"></i> Your Role</h4>
                                <p>As an Faculty, you can create and manage sections, track student attendance, grade assignments, and maintain comprehensive records of academic activities.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Developer:</strong> Satish & team</li>
                                    <li><strong>Role:</strong> Operations Analyst</li>
                                    <li><strong>Organization:</strong> BGI</li>
                                    <li><strong>Email:</strong> satishnagar248@gmail.com</li>
