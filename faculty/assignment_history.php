...
$stmt = $db->prepare("SELECT * FROM sections WHERE faculty_id = ? ORDER BY name");
$stmt->execute([$faculty_id]);
...
<head>
    ...
    top: 70px; /* Assuming your header height is 70px */
    left: 0;
    overflow: hidden;
        }
        .btn-sidebar {
...
<body>
    ...
    <footer class="text-center mt-5 mb-3 text-muted small">QuickMark - Presented by Satish & team...</footer>
